    ...
    <div class="my-20 mx-auto w-full max-w-7xl lg:px-8">
        <div class="relative px-4 sm:px-8 lg:px-12">
            <div class="mx-auto max-w-2xl lg:max-w-5xl">
                <div
                    class="mb-8 flex justify-end page-enter-item"
                    style="--enter-index: 0"
                >
                    <a
                        href="/rss.xml"
                    ...
                    <div class="flex max-w-3xl flex-col space-y-16">
                        {#each data.posts as post, index}
                            ...
                            >
                                ...
                                >
                                    <h2
                                        class="text-3xl tracking-tight text-neutral-800 dark:text-neutral-100"
                                    >
                                        <div
                                    ...
                                    <div
                                        aria-hidden="true"
                                        class="relative z-10 mt-4 flex items-center text-center align-center gap-2 text-md text-primary"
                                    >
                                        Read article
